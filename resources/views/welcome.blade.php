...
<body class="bg-gray-100 text-gray-900 font-sans antialiased">
    ...
    <header class="bg-white shadow-md px-6 py-4 flex justify-between items-center">
        <h1 class="text-xl font-bold text-yellow-900">Nurse Admin Lite</h1>
    ...
    <div class="min-h-[80vh] flex items-center justify-center">
        <div class="flex flex-col md:flex-row  overflow-hidden w-full max-w-5xl">
            ...
            <div class="md:w-1/2 flex flex-col items-center justify-center p-10 text-center space-y-6">
                <h1 class="font-bold text-black text-5xl">Nurse Admin Lite</h1>

                <div class="flex flex-col space-y-4 w-full max-w-xs">
                    <a href="{{ route('login') }}"
                        class="block w-full text-center bg-yellow-600 text-white py-3 rounded-2xl hover:bg-yellow-300 transition">
                        Login
                    </a>
    ...
    <section id="contact" class="bg-white border-t mt-10 py-8 px-6 text-center">
        ...
        <p class="text-gray-700 mb-1">✉️ Email: support@nurseadminlite.com</p>
        <p class="text-gray-700">🌐 Website: www.nurseadminlite.com</p>
    </section>

    <!-- Footer -->
    <footer class="text-center py-4 text-sm text-gray-600 bg-gray-50 border-t">
        &copy; {{ now()->year }} Nurse Admin Lite. All rights reserved.
    </footer>
